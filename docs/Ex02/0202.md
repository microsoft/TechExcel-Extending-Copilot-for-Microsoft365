...
### Task 02.1 - Review **config.ts** file
...
### Task 02.2 - Review building blocks of creating a connection (calling the API)
...
### Task 02.3 - Review building blocks of creating the Schema
...
### Task 02.4 - Recall the Microsoft Graph again 
